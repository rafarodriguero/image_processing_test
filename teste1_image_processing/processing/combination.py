...
def find_difference(image1, image2):
    ...
    print("Simlarity of the images:", score)
    normalized_difference_image = (difference_image.np.min(difference_image))/(np.max(difference_image)-np.mim(difference_image))
